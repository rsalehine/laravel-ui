                ...
                @if (empty($item['hideInSidebar']))
                    <li class="flex">
                        <a
                            ...
                            class="ease-linear text-sm fx-active:text-fg-title fx-active:bg-bg-subtle text-fg-muted font-light hover:text-fg-title px-3 py-1.5 rounded-lg hover:bg-bg-muted w-full"
                            wire:navigate
                        >
                            {{ $item['title'] }}
                            @if (!empty($item['state']))
