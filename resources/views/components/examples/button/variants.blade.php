            ...
            <div data-invisible-scrollbar class="grid overflow-x-auto">
                ...
                <div class="p-4 rounded-md border border-border-strong/60 gap-4 grid min-w-max">
                    ...
                    <div class="flex items-center gap-x-4">
                        ...
                        <x-ui.button size="sm" variant="outline" intent="gray">Click Me</x-ui.button>
                        <x-ui.button size="sm" variant="soft" intent="gray">Click Me</x-ui.button>
                        <x-ui.button size="sm" variant="ghost" intent="gray">Click Me</x-ui.button>
                    </div>
                    <div class="flex items-center gap-x-4">
