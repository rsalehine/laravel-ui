<x-layouts.doc-page-wrapper :current="$current" :current="$current" :prev-slug="$prevSlug" :next-slug="$nextSlug" :links="[]">
    ...
    <x-md.paragraph>
        You must have a dedicated file name <x-docs.inline-code text="button-.css" /> where to put all your button
        utilities.
    </x-md.paragraph>
    ...
    <livewire:load-code :name="['ui-solid-both', 'ui-solid-light', 'ui-solid-dark']" />
    ...
    <livewire:load-code :name="['ui-outline-both', 'ui-outline-light', 'ui-outline-dark']" />
    <x-docs.component-prev>
    ...
    <livewire:load-code :name="['ui-soft-both', 'ui-soft-light', 'ui-soft-dark']" />
    <x-docs.component-prev>
        <x-docs.demo-ui variant="soft" />
    </x-docs.component-prev>

    <x-md.h3>Subtle variants</x-md.h3>
    <livewire:load-code :name="['ui-subtle-both', 'ui-subtle-light', 'ui-subtle-dark']" />
    <x-docs.component-prev>
