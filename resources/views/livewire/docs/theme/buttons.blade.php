<x-layouts.doc-page-wrapper :current="$current" :current="$current" :prev-slug="$prevSlug" :next-slug="$nextSlug" :links="[]">
    ...
    <livewire:load-code :name="['btn-solid-both', 'btn-solid-light', 'btn-solid-dark']" />
    ...
    <livewire:load-code :name="['btn-flexi-both', 'btn-flexi-light', 'btn-flexi-dark']" />
    <x-docs.component-prev>
    ...
    <livewire:load-code :name="['btn-outline-both', 'btn-outline-light', 'btn-outline-dark']" />
    <x-docs.component-prev>
    ...
    <livewire:load-code :name="['btn-soft-both', 'btn-soft-light', 'btn-soft-dark']" />
    <x-docs.component-prev>
        <x-docs.demo-buttons variant="soft" />
    </x-docs.component-prev>

    <x-md.h3>Ghost variants</x-md.h3>
    <livewire:load-code :name="['btn-ghost-both', 'btn-ghost-light', 'btn-ghost-dark']" />
    <x-docs.component-prev>
