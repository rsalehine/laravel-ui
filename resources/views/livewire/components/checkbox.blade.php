<x-layouts.doc-page-wrapper :current="$current" :prev-slug="$prevSlug" :next-slug="$nextSlug">
    ...
    <x-docs.tabs-installation>
        ...
        <x-md.paragraph>
            Then you need to paste the code in your project's <x-docs.inline-code text="checkbox.blade.php" /> file insise
            your <strong>resources/views/components/ui/</strong> folder.
        </x-md.paragraph>
        <livewire:component-source :data="['resources/views/components/ui/checkbox.blade.php']" />
    </x-docs.tabs-installation>
