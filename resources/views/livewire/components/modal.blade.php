        ...
        <x-docs.steps>
            <x-docs.step>
                ...
                <livewire:component-source :data="[
                    ...
                    'resources/views/components/ui/modal/content.blade.php',
                    'resources/views/components/ui/modal/trigger.blade.php',
                    'resources/views/components/ui/modal/close.blade.php',
                    ...
                    'resources/views/components/ui/modal/title.blade.php',
                    'resources/views/components/ui/modal/description.blade.php',
                ]" />
            </x-docs.step>
            <x-docs.step>
